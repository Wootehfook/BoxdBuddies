...
- **IMPORTANT**: After you finish generating or modifying any code files, you MUST call the `analyze_file_list` tool (if it exists) to analyze the files you created or modified.
...
- **IMPORTANT**: When you are done generating code, you MUST re-enable automatic analysis with the `toggle_automatic_analysis` tool if it exists.
